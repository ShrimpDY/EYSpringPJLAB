<template>
  <div>
    <div class="OA_header_layout">
      <h3 class="OA_header">
        <span class="OA_header_span">Overtime Key Highlights</span>
      </h3>
    </div>
    ...
    <key-overtime-analysis ref="KeyOvertimeAnalysis"></key-overtime-analysis>
  </div>
</template>

<script>
import KeyOvertimeAnalysis from '@/components/Cards/KeyOvertimeAnalysis'
...
export default {
  ...
  components: {KeyOvertimeAnalysis},
  data: function () {
    return {
      selected: [],
      options: [],
  ...
  methods: {
    getData () {
      ...
      this.$refs.KeyOvertimeAnalysis.getDataLine('tier-1-capital-overtime', this.quarter1, this.quarter2, this.selected)
      this.$refs.KeyOvertimeAnalysis.getDataLine('tier-2-capital-overtime', this.quarter1, this.quarter2, this.selected)
      this.$refs.KeyOvertimeAnalysis.getDataLine('tier-1-ratio-overtime', this.quarter1, this.quarter2, this.selected)
      this.$refs.KeyOvertimeAnalysis.getDataLine('total-exposure-overtime', this.quarter1, this.quarter2, this.selected)
      this.$refs.KeyOvertimeAnalysis.getDataLine('ratio-of-rwa-and-total-assets', this.quarter1, this.quarter2, this.selected)
